...
extern int bitmap_get_width(Bitmap_t *bitmap);
extern int bitmap_set_height(Bitmap_t *bitmap);
extern struct color bitmap_get_color_at(Bitmap_t *bitmap, int row, int col);
